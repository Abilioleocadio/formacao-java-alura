...
//		NumeroDaContaComparator comparador = new NumeroDaContaComparator();
		lista.sort(new TituloDaContaComparator());
		
//		Collections.sort(lista, new NumeroDaContaComparator());
//		Collections.sort(lista); // Ordenação natural
//		Collections.reverse(lista); // Reverter a ordem estabelecida
//		Collections.shuffle(lista); // Embaralhar a ordem de uma lista
...
//		
//		if(c1.getNumero() > c2.getNumero()) {
//			return 1; // Qualquer valor positivo
//		}
//		
//		return 0;
	}
